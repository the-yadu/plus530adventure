...
export const adventures: Adventure[] = [
  {
    ...
    backgroundImage: '/images/adventures/bhutan-car-convoy.jpg',
    nextBatchDates: ['15th Oct 2026', '05th Nov 2026'],
    featured: true,
    gallery: [
      '/images/adventures/bhutan-car-convoy.jpg',
  ...
  },
  {
    ...
    price: '₹1,74,300',
    image: '/images/adventures/ladakh-car-convoy.jpg',
    backgroundImage: '/images/adventures/ladakh-car-convoy.jpg',
    nextBatchDates: ['15th Jun 2026', '10th Jul 2026'],
    featured: false,
    gallery: [
      '/images/adventures/ladakh-car-convoy.jpg',
  ...
  },
  {
    ...
    type: 'car',
    title: 'The Coffee & Ghats Escape: Chikmagalur × Sakleshpur',
    description: 'A 3-Day / 2-Night luxury self-drive convoy through tea estates, misty peaks, and scenic trails of Chikmagalur & Sakleshpur with boutique estate stays.',
    longDescription: 'Our flagship October drive takes us into Karnataka\'s coffee country, combining the highlands of Chikmagalur with the lush Western Ghats around Sakleshpur (02–04 October 2026). Expect long stretches of beautiful driving, estate experiences, carefully selected meals and premium stays — without the rush of a conventional sightseeing itinerary. Bring your car. Bring your people. We\'ll take care of the rest.',
    duration: '3 Days / 2 Nights',
    difficulty: 'Moderate',
    price: '₹38,500',
    image: '/images/adventures/sakleshpur-car-convoy.jpg',
    backgroundImage: '/images/adventures/sakleshpur-car-convoy.jpg',
    nextBatchDates: ['02nd Oct 2026', '20th Nov 2026'],
    featured: true,
    gallery: [
      '/images/adventures/sakleshpur-car-convoy.jpg',
      '/images/adventures/sakleshpur-chikmagalur.jpg',
    ],
    highlights: [
      'Boutique luxury estate stays in Chikmagalur & Sakleshpur',
      'Curated self-drive convoy led by dedicated Plus530 trip host',
      'Belur heritage stop and scenic highway drive via NH75',
      'Sunrise hill drive and coffee country heritage walk',
      'Late-afternoon estate drive through Sakleshpur countryside',
      'Sunset, sundowners, and private dinner around the fire',
    ],
    included: [
      'Curated self-drive route & convoy leadership',
      'Driver & route briefing',
      'Premium accommodation in Chikmagalur & Sakleshpur',
      'Curated meals (Breakfasts, En-route Lunches, Private Dinners)',
      'Coffee estate walk and heritage experience',
      'Scenic driving routes & dedicated Plus530 trip host',
      'Roadside coordination & group photography / trip content',
    ],
    itinerary: [
      {
        day: 1,
        title: 'Bengaluru to Chikmagalur: Convoy Meet, Belur Heritage & Coffee Country Arrival',
        description: 'Convoy meet-up at designated Bengaluru start point at 05:30 AM for driver briefing and convoy formation. Roll out at 06:00 AM via NH75. Curated highway breakfast stop at 08:00 AM, followed by a short heritage stop at Belur at 10:30 AM. Arrive in Chikmagalur coffee country by 01:00 PM and check into our premium stay. After lunch, embark on our first curated afternoon drive through winding Chikmagalur hills, concluding with a lakeside sunset stop and dinner with the convoy at 08:00 PM.',
      },
      {
        day: 2,
        title: 'Chikmagalur to Sakleshpur: Sunrise Hill Drive, Coffee Heritage & Fireside Evening',
        description: 'Early 06:30 AM sunrise drive along quiet hill roads before breakfast at 08:30 AM. Walk through coffee country at 10:00 AM to learn the region\'s heritage. Depart at 12:30 PM along scenic backcountry roads towards Sakleshpur with a leisurely lunch en route. Arrive at our Sakleshpur estate stay by 04:00 PM, followed by a late-afternoon countryside estate drive. Conclude the day with sunset sundowners and a private Plus530 dinner around the fire at 08:30 PM.',
      },
      {
        day: 3,
        title: 'Sakleshpur to Bengaluru: Western Ghats Run, Local Coffee & Return Journey',
        description: 'A slow morning at the estate with breakfast at 07:00 AM. Roll out at 08:30 AM for one final scenic run through the Western Ghats, stopping at 10:30 AM for freshly brewed local estate coffee. Convoy departs towards Bengaluru at 11:30 AM, stopping for a relaxed highway lunch at 01:30 PM. The final convoy leg continues towards Bengaluru, arriving between 06:00 and 07:00 PM where the trip concludes.',
      },
    ],
  },
  {
    ...
    difficulty: 'Challenging',
    price: '₹2,85,000',
    image: '/images/adventures/northeast-car-convoy.jpg',
    backgroundImage: '/images/adventures/northeast-car-convoy.jpg',
    nextBatchDates: ['15th Jan 2027', '20th Feb 2027'],
    featured: true,
    gallery: [
      '/images/adventures/northeast-car-convoy.jpg',
  ...
  {
    id: '12',
    slug: 'the-wine-drive-nandi-hills',
    type: 'car',
    title: 'The Wine Drive: Nandi Hills & Grover Zampa',
    description: 'A relaxed 1-Day self-drive escape from Bengaluru combining scenic cruising, vineyard walking tour, barrel-room tasting, and a seated 3-course lunch.',
    longDescription: 'Escape the city on a curated one-day self-drive convoy to the vineyards of Nandi Hills (18 October 2026). A relaxed Sunday drive through quiet backcountry routes, artisanal estate breakfast, guided vineyard walk and barrel-room tasting, topped off with a leisurely 3-course lunch. Strictly adheres to designated-driver safety with zero compromise on luxury and overland camaraderie.',
    duration: '1 Day',
    difficulty: 'Easy',
    price: '₹5,500',
    image: '/images/adventures/wine-drive-convoy.jpg',
    backgroundImage: '/images/adventures/wine-drive-convoy.jpg',
    nextBatchDates: ['18th Oct 2026'],
    featured: true,
    gallery: [
      '/images/adventures/wine-drive-convoy.jpg',
    ],
    highlights: [
      'Scenic morning convoy drive out of Bengaluru towards Nandi Hills foothills',
      'Artisanal South Indian highway breakfast stop en route',
      'Guided private vineyard tour & barrel-room walkthrough at Grover Zampa',
      'Curated seated 3-course vineyard lunch paired with guided wine tasting',
      'Strict designated driver protocol with premium non-alcoholic tasting options',
      'Dedicated Plus530 convoy lead, vehicle briefing & radio coordination',
    ],
    included: [
      'Guided vineyard tour and barrel-room access at Grover Zampa',
      'Curated seated 3-course vineyard lunch',
      'Guided wine tasting flight (or artisanal non-alcoholic alternative)',
      'Convoy lead support and route briefing',
      'Dedicated Plus530 host throughout the day',
      'Convoy photography and digital trip album',
    ],
    itinerary: [
      {
        day: 1,
        title: 'Bengaluru to Grover Zampa: Morning Convoy, Vineyard Tour & Tasting Lunch',
        description: 'Convoy assembly at designated Bengaluru assembly point at 07:00 AM for route briefing and radio allocation. Roll out at 07:30 AM via scenic expressway towards Nandi Hills foothills. Relaxed breakfast stop en route at 08:30 AM. Arrive at Grover Zampa Vineyards by 10:30 AM for a guided vineyard walk, estate history, and barrel-room tour. Followed by a seated 3-course lunch paired with guided wine tasting at 12:30 PM (designated driver protocol strictly maintained). Enjoy estate grounds and photo sessions before regrouping at 03:30 PM for a relaxed return convoy drive back to Bengaluru, arriving by 05:30 PM.',
      },
    ],
  },
  {
    id: '13',
    slug: 'kabini-wilderness-drive',
    type: 'car',
    title: 'The Wilderness Drive: Bengaluru × Mysuru × Kabini',
    description: 'A 2-Day / 1-Night luxury overland escape to the dense teak forests of Kabini, featuring expressway cruising, luxury safari resort stay, jungle safaris, and campfire sundowners.',
    longDescription: 'Experience the raw beauty of Karnataka\'s premier wildlife corridor on an immersive 2-Day / 1-Night self-drive convoy from Bengaluru to Kabini (31 October – 01 November 2026). Cruise the Bengaluru-Mysuru Expressway, skirt the edge of Nagarhole Tiger Reserve, unwind in luxury riverbank resort accommodations, and track wildlife on guided jungle safaris. Spend your evening with campfire conversations and sundowners alongside fellow overland enthusiasts.',
    duration: '2 Days / 1 Night',
    difficulty: 'Moderate',
    price: '₹26,500',
    image: '/images/adventures/kabini-wilderness-convoy.jpg',
    backgroundImage: '/images/adventures/kabini-wilderness-convoy.jpg',
    nextBatchDates: ['31st Oct 2026'],
    featured: true,
    gallery: [
      '/images/adventures/kabini-wilderness-convoy.jpg',
    ],
    highlights: [
      'Expressway cruise via Bengaluru-Mysuru Expressway & scenic forest fringe roads',
      'Luxury wildlife resort accommodation on the banks of Kabini River',
      'Guided jungle safari in Nagarhole National Park (boat or jeep safari)',
      'Evening naturalist talk, campfire sundowners & outdoor dinner',
      'Morning riverbank birdwatching walk or dawn forest trail run',
      'Dedicated Plus530 lead support vehicle, walkie-talkie comms & convoy host',
    ],
    included: [
      '1 Night luxury wildlife resort stay (Double Occupancy)',
      'All meals (Expressway Breakfast, Jungle Lunch, Campfire Dinner & Farewell Breakfast)',
      'Guided Nagarhole jungle safari (Boat or 4x4 Jeep safari subject to forest permits)',
      'Plus530 lead support vehicle, certified trip leader & walkie-talkie radio setup',
      'All forest entry permits, naturalist fees, and resort taxes',
      'Roadside assistance, convoy photography & digital memory pack',
    ],
    itinerary: [
      {
        day: 1,
        title: 'Bengaluru to Kabini: Expressway Cruise, Forest Fringe Drive & Afternoon Safari',
        description: 'Convoy assembly at 05:30 AM at NICE Road junction for driver briefing and radio setup. Depart at 06:00 AM cruising the Bengaluru-Mysuru expressway with an authentic Mysore breakfast stop at 07:30 AM. Bypass Mysuru towards the dense teak forests of Kabini, arriving at our luxury jungle resort by 12:30 PM for lunch and check-in. At 03:00 PM, head out for a guided wildlife safari into Nagarhole National Park tracking elephants, leopards, and tigers. Evening campfire, naturalist storytelling, and dinner under the stars at 08:00 PM.',
      },
      {
        day: 2,
        title: 'Kabini Dawn Safari / Birding & Scenic Return Drive to Bengaluru',
        description: 'Early morning dawn birdwatching walk along the riverbanks or optional second safari drive at 06:00 AM. Hearty resort breakfast at 09:00 AM and relaxed checkout. Roll out at 10:30 AM taking scenic interior backroads towards Mysuru, stopping for a curated lunch at a heritage café at 01:00 PM. Continue along the expressway back to Bengaluru, with arrival expected between 05:30 PM and 06:30 PM where the convoy concludes.',
      },
    ],
  },
];
