...
export const adventures: Adventure[] = [
  ...
  },
  {
    ...
    description: 'A 3-Day / 2-Night luxury self-drive convoy through tea estates, misty peaks, and scenic trails of Sakleshpur & Chikmagalur with 4-star resort stays.',
    longDescription: 'Embark on a premium 3-Day / 2-Night Western Ghats overland expedition from Bangalore to Sakleshpur and Chikmagalur (Oct 2 – Oct 4, 2026). Drive your own car or SUV behind our expert lead support vehicle, exploring private coffee plantations, mountain passes, and waterfalls, while unwinding each evening in handpicked 4-star luxury resorts.',
    ...
    highlights: [
      ...
      'Self-drive convoy led by Plus530 professional support team',
      'Private coffee & tea estate trail drive (suitable for all vehicles)',
      'Sunset drive to Mullayanagiri Peak (Karnataka\'s highest peak)',
      'Explore Baba Budangiri & estate waterfalls',
      'Walkie-talkie communication sets & full support team',
    ],
    included: [
      '2 Nights stay in 4-Star Luxury Resorts (Double Occupancy)',
      'All meals (Breakfasts, Highway & Estate Lunches, Gourmet Dinners)',
      'Plus530 Lead Support Vehicle & Experienced Expedition Leader',
      'Spotters & assistance team on standby',
    ...
    itinerary: [
      {
        day: 1,
        title: 'Bangalore to Sakleshpur: Highway Cruise & Estate Plantation Trail',
        description: 'Convoy assembly in Bangalore at 6:00 AM. Scenic highway drive to Sakleshpur. Check-in at 4-star luxury estate resort. Afternoon scenic trail through private coffee plantations and hidden streams. Evening welcome dinner & briefing.',
      },
      {
        day: 2,
